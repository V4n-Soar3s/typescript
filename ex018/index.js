...
let numeros = [1, 2, 3]; //se inserirmos um dado de tipo string vai ser apresentado erro, pois, estamos lidando com um array do tipo number, nao podemos mudar o tipo de dados aqui 
